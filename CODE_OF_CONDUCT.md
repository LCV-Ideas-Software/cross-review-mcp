...
When a reviewer's feedback is technically sharp but professionally framed, that is the protocol working as designed (see spec `§2` and `feedback_peer_review_rigor.md`). When personal conduct crosses the Contributor Covenant standard, that is a CoC matter handled via the enforcement contact above.
